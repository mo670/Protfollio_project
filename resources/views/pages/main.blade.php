...
<html lang="en">
    ...
    <body id="page-top">
                ...
                <div class="row">
                    <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal<?php echo $protfollio->id?>">
                                <div class="portfolio-hover">
                                    <div class="portfolio-hover-content"><i class="fas fa-plus fa-3x"></i></div>
                                </div>
                                <img class="img-fluid" src="/img/{{$protfollio->small_image}}" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">{{$protfollio->client}}</div>
                                <div class="portfolio-caption-subheading text-muted">{{$protfollio->catagory}}</div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="page-section" id="about">
            <div class="container">
                ...
                <ul class="timeline">
                    ...
                    <li>
                        <div class="timeline-image"><img class="rounded-circle img-fluid" src="/img/{{$about->image}}" alt="..." /></div>
        ...
        <section class="page-section" id="contact">
            <div class="container">
                ...
                <form id="contactForm"  action="{{route('contact.store')}}"  method="post">
                    ...
                    <!-- Submit Button-->
                    {{-- <div class="text-center"><button class="btn btn-primary btn-xl text-uppercase disabled"  type="submit">Send Message</button></div> --}}
                </form>
            </div>
        </section>
        <!-- Footer-->
        ...
        <div class="portfolio-modal modal fade" id="portfolioModal<?php echo $protfollio->id?>" tabindex="-1" role="dialog" aria-hidden="true">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    <!-- Project details-->
                                    <h2 class="text-uppercase">{{$protfollio->title}}</h2>
                                    <p class="item-intro text-muted">{{$protfollio->subtitle}}</p>
                                    <img class="img-fluid d-block mx-auto" src="/img/{{$protfollio->big_image}}" alt="..." />
                                    <p>{{$protfollio->description}}</p>
